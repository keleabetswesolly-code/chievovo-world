...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]" {...ptr}>
      ...
      <header className="sticky top-0 z-40 px-5 bg-gradient-to-b from-[#0A0A0A] via-[#0A0A0A]/95 to-transparent" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 16px)', paddingBottom: '16px' }}>
